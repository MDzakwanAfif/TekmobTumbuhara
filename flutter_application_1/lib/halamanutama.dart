...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> _navigateToAddEditTransaction(TransactionType type,
    ...
    return Scaffold(
                ...
                IconButton(
                    ...
                    onPressed: () {
                      Navigator.of(context).push(MaterialPageRoute(
                          builder: (context) =>
                              HistoryPage(allTransactions: _allTransactions)));
                    }),
              ],
            ),
          ),
      ...
      body: StreamBuilder<List<Transaction>>(
        ...
        builder: (context, snapshot) {
          ...
          final transactionsForSelectedDate = _allTransactions
              .where((t) =>
              ...
              child: Row(
                ...
                children: [
                  Container(
                    ...
                    child: const Text('Pemasukan', style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold)),
                  ),
              ...
              child: Row(
                ...
                children: [
                  Container(
                    ...
                    child: const Text('Pengeluaran', style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold)),
                  ),
                  const SizedBox(width: 8),
                  FloatingActionButton.small(
                    heroTag: 'expenseFab',
      ...
      bottomNavigationBar: BottomNavigationBar(
        items: const <BottomNavigationBarItem>[
          ...
          BottomNavigationBarItem(
              icon: Icon(Icons.account_balance_wallet), label: 'Hutang'),
  ...
  Widget _buildContent(BuildContext context,
      List<Transaction> dailyTransactions, NumberFormat formatter) {
            ...
            child: Row(
              children: [
                Expanded(
                  ...
                  Text('+${formatter.format(balances['income'])}',
                      style: const TextStyle(
                          fontSize: 18,
                ...
                Expanded(
                  ...
                  const Text('Pengeluaran',
                      style: TextStyle(fontSize: 14, color: Colors.grey)),
                  const SizedBox(height: 5),
                  Text(formatter.format(balances['expense']),
                      style: const TextStyle(
                          fontSize: 18,
                          fontWeight: FontWeight.bold,
                          color: Colors.red)),
                ...
                Expanded(
                  ...
                  const SizedBox(height: 5),
                  Text(
                      '${balances['balance']! >= 0 ? '+' : ''}${formatter.format(balances['balance'])}',
                      style: TextStyle(
                          fontSize: 18,
                          fontWeight: FontWeight.bold,
                          color: balances['balance']! >= 0
                              ? Colors.black87
                              : Colors.red)),
                ])),
              ],
              ...
              : ListView(
                  ...
                  children: dailyTransactions.map((transaction) {
                    return _buildTransactionItem(
                      ...
                      onEdit: () => _navigateToAddEditTransaction(
                          transaction.type,
  ...
  Widget _buildTransactionItem(
      {required Transaction transaction, required VoidCallback onEdit}) {
    final formatter = NumberFormat.decimalPattern('id_ID');
